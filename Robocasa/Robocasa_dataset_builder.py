...
from Robocasa.conversion_utils import MultiThreadedDatasetBuilder
...
def _generate_examples(paths) -> Iterator[Tuple[str, Any]]:
    ...
    def _parse_example(episode_path, demo_id):
        ...
        with h5py.File(episode_path, "r") as F:
            ...
            left_images = F["data"][f"demo_{demo_id}"]["obs"]["agentview_left_rgb"][()]
            right_images = F["data"][f"demo_{demo_id}"]["obs"]["agentview_right_rgb"][
                ()
            ]
...
class Robocasa(MultiThreadedDatasetBuilder):
